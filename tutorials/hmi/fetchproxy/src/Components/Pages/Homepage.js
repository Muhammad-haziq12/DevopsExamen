import { clearPage } from '../../utils/render';
  ...
  /* moyen avec une function  async await  
  ...
  */
  ...
  /* moyen avec un async await */
  const HomePage = async () => {
    try {
      clearPage();

     /* const pizzas = await getAllPizzas(); */ // on peut faire comme ça ou comme ci-dessous
